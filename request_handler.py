...
# Here's a class. It inherits from another class. For now, think of a class as a container for functions that work together for a common purpose. In this case, that
